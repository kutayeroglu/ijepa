...
#SBATCH --gres=gpu:1
#SBATCH --output=%j_lp1_mAn50.out
#SBATCH --error=%j_lp1_mAn50.err
#SBATCH --chdir=.
...
# -- Config --
CONFIG_TAG="${CONFIG_TAG:-bal_hi-lo_mn50_vitb}"
PRETRAINING_RUN_ID="${PRETRAINING_RUN_ID:-37977344_bal_hi-lo_mn50_vitb}"
