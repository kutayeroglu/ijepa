...
#SBATCH --gres=gpu:4
#SBATCH --output=%j_pt100_mn10_vitb.out
#SBATCH --error=%j_pt100_mn10_vitb.err
#SBATCH --chdir=.
...
# -- Config --
CONFIG_NAME="bal_mn10_vitb" # TODO
...
print_run_header
echo "--- Executing I-JEPA (color_mask_ratio=0.10) ---"
singularity exec --nv \
    --bind "$BIND_ARGS" \
    "$SIF_IMAGE" \
