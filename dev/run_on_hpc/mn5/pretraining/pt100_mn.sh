...
#SBATCH --gres=gpu:4
#SBATCH --output=%j_balon_noise.out
#SBATCH --error=%j_balon_noise.err
#SBATCH --chdir=.
...
SCRIPT_PATH="dev/run_on_hpc/mn5/pretraining/pt100_mn.sh"
CONFIG_PATH="configs/balon_mnoise.yaml"
RUN_TAG="balon_mnoise_vitb"
