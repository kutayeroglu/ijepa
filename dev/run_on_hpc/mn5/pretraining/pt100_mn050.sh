...
#SBATCH --gres=gpu:4
#SBATCH --output=%j_cmr050.out
#SBATCH --error=%j_cmr050.err
#SBATCH --chdir=.
...
SCRIPT_PATH="dev/run_on_hpc/mn5/pretraining/pt100_mn050.sh"
CONFIG_PATH="configs/balon_mnoise_cmr050.yaml"
RUN_TAG="balon_mnoise_cmr050_vitb"
...
print_run_header
echo "--- Executing I-JEPA (color_mask_ratio=0.5) ---"
singularity exec --nv \
    --bind "$BIND_ARGS" \
    "$SIF_IMAGE" \
