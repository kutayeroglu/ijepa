...
#SBATCH --gres=gpu:4
#SBATCH --output=%j_sanity_balblock.out
#SBATCH --error=%j_sanity_balblock.err
#SBATCH --chdir=.
...
SCRIPT_PATH="dev/run_on_hpc/mn5/pretraining/pt100_mb.sh"
CONFIG_PATH="configs/balon_mblock.yaml"
RUN_TAG="balon_mblock_vitb"
