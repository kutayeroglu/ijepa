...
#SBATCH --gres=gpu:4
#SBATCH --output=%j_pt_mn50VitL.out
#SBATCH --error=%j_pt_mn50VitL.err
#SBATCH --chdir=.
...
SCRIPT_PATH="dev/run_on_hpc/mn5/pretraining/pt100_mn050_vitl.sh"
CONFIG_PATH="configs/balon_mnoise_cmr050_vitl.yaml"
RUN_TAG="balon_mnoise_cmr050_vitl"
...
print_run_header
echo "--- Executing I-JEPA (color_mask_ratio=0.5, vit-large) ---"
singularity exec --nv \
    --bind "$BIND_ARGS" \
    "$SIF_IMAGE" \
