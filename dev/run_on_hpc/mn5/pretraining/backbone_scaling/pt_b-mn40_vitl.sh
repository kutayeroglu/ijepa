...
#SBATCH --gres=gpu:4
#SBATCH --output=%j_pt_blue-mn40_vitl.out
#SBATCH --error=%j_pt_blue-mn40_vitl.err
#SBATCH --chdir=.
...
CONFIG_NAME="${CONFIG_NAME:-blue-bal_mn40_vitl}"
...
# -- Data --
NOISE_FILENAME="${NOISE_FILENAME:-blue_noise_data_3072.npz}"
